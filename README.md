...
| --- | --- | --- | --- | --- |
| 0 — Contract | `agents/type-author.md` | gpt-5.4 (reasoning: high) | `.ts`/`.tsx` (non-test) | test files |
| 1 — RED | `agents/test-author.md` | gpt-5.4 | test files only | all source and types; reading `tasks.md` |
| 2 — GREEN | `agents/implementer.md` | gpt-5.3-codex (reasoning: low) | source | test files |
