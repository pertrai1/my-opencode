...
description: Use only when the user explicitly invokes the OpenSpec continue workflow.
...
In this configuration, route `/opsx-continue` through `sdlc-orchestrator`,
which owns lifecycle decisions and planning delegation. Do not use the direct
